...
async function seed() {
  ...
  const collegesData = [
    {
      ...
      fees_min: 2300000,
      fees_max: 2500000,
      avg_package: 33600000,
      highest_package: 150000000,
    ...
    },
    {
      ...
      fees_min: 2200000,
      fees_max: 2400000,
      avg_package: 28500000,
      highest_package: 75000000,
    ...
    },
    {
      ...
      fees_min: 4100000,
      fees_max: 4500000,
      avg_package: 34800000,
      highest_package: 130000000,
  ...
  for (const c of collegesData) {
    const res = await query(
      ...
      [
        c.name, c.slug, `/images/colleges/${c.slug}-logo.png`, `/images/colleges/${c.slug}-banner.jpg`,
    ...
    await query(
      ...
      [res.insertId, `/images/colleges/${c.slug}-campus.jpg`, `${c.name} Campus`]
    );
  }
